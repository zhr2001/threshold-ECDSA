...
int main() {
    ...
    char *message = "Hello!";
    sign *sign = sign_message(kp->privateKey, message, group);
    gmp_printf("Sign: (%Zd, %Zd)\n", sign->r, sign->s);

    if (verifySignature(kp->publicKey, message, sign, group)) printf("PASS!\n");
}

// Sign: (89578011305203426357494261505270433926638756165426589388698937233968118474419, 9056892743108765099858605370117207548700216242494120761139563802023329858811)